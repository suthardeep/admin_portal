...
const toggleButtonClasses =
  "cursor-pointer transition-colors duration-200 focus:outline-none text-body-content hover:text-body-content";
              ...
              >
                {togglePassword && type === "password" ? (
                  ...
                  >
                    ...
                    <Icon name="EyeOff" size={20} className="text-body-content"></Icon> :<Icon name="Eye" size={20} className="text-body-content"></Icon>}
                  </button>
