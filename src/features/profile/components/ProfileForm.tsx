...
import { useGetAllRolesQuery } from "@/features/sub-admins/roles/api/queryHooks";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div>
            <MediaPicker
              ...
              value={profileData?.profileImageUrl ? [{
                id: 'current',
                s3Url: profileData.profileImageUrl
              }] : []}
              ids={profileData?.profileImageUrl ? 'current' : ''}
              urls={profileData?.profileImageUrl || ''}
              onChange={() => {}} // Read-only
              maxFiles={1}
              orientation="grid"
              gridConfig={{
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Dropdown
                label="Roles"
                value={profileData?.customRoles?.map(role => role.id) || []}
                onChange={() => {}} // Read-only
                options={roleOptions}
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={cn(
                      ...
                      profileData?.allowSensitiveInfo
