...
export function getStatusColor(status: string | null | undefined): ChipColor {
...
export function createStatusColorMap(statuses: (string | null | undefined)[]): Record<string, ChipColor> {
